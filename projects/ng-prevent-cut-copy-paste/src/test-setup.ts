...
const Zone = (globalThis as Record<string, unknown>)['Zone'] as
  | {
      current: {
        fork: (spec: unknown) => {
          run: (
...
if (
  ...
  const origBeforeEach = g['beforeEach'] as (
    fn: Function,
    ...a: unknown[]
  ) => void
  const origAfterEach = g['afterEach'] as (
    fn: Function,
    ...a: unknown[]
  ) => void
  const origIt = g['it'] as ((
    name: string,
    fn: Function,
    ...a: unknown[]
  ) => void) & {
  ...
  g['beforeEach'] = (fn: Function, ...a: unknown[]) =>
    origBeforeEach(wrapInProxyZone(fn) as Function, ...a)
  g['afterEach'] = (fn: Function, ...a: unknown[]) =>
    origAfterEach(wrapInProxyZone(fn) as Function, ...a)
  g['it'] = (name: string, fn: Function, ...a: unknown[]) =>
    origIt(name, wrapInProxyZone(fn) as Function, ...a)
  g['test'] = (name: string, fn: Function, ...a: unknown[]) =>
    origTest(name, wrapInProxyZone(fn) as Function, ...a)
